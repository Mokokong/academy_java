package com.bptn.course.week4.day2.codingchallenge;
...
public class DeleteDuplicates {
	...
	public static List<Integer> deleteDuplicates(List<Integer> nums) {
		...
		/*
		 * TreeSets are sorted and cannot have duplicates
		 * */
		TreeSet<Integer> setNums = new TreeSet<Integer>(nums);
		
		

		// return sortedAndUnique arraylist
		return  new ArrayList<>(setNums);
