package com.bptn.course.week4.day4.coding411;
...
public class StreamExercise {
    ...
    public static void main(String[] args) {
        ...
        // Print the count
        System.out.println("Count numbers of words in the list " + wordCount  );
       ...
       List<String> wordsUpperCase = words.stream()
        ...
        System.out.println("Words in upper case " + wordsUpperCase );
    }
}